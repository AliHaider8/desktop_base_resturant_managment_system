...
{    
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Century Gothic", 8, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Century Gothic", 18, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Blue;
            subtitlefont = new Font("Century Gothic", 12, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("Century Gothic", 10, FontStyle.Bold, GraphicsUnit.Point);
